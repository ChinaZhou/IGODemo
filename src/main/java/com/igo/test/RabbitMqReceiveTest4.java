 ...
 */
public class RabbitMqReceiveTest4 {


    public static void main(String[] args) {
        MQReceiver receiver = null;
        try {
            receiver = new MQReceiver(RabbitMqQueueNames.FANOUN_TEST_2);
            ...
            channel.queueBind(RabbitMqQueueNames.FANOUN_TEST_2, exchangeName, "");
